...
--same as code above but using aliases
SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	de.to_date
...
--adding order by to code above so output is in order
SELECT COUNT(ce.emp_no), de.dept_no
...
--I think these two are correct for skill drills 7.3.6
SELECT de.emp_no, 
	ei.first_name, 
	ei.last_name,
	d.dept_name
